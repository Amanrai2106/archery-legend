...
var charIndex = 0;
var typingSpeed = 50;
var isStoryShown = false; // Flag to track if story has been shown
...
function startStory() {
    isStoryShown = true; // Mark as shown
...
startBtn.addEventListener("click", function(e) {
    ...
    if (!isStoryShown) {
        startStory(); // Show story only for the first time
    } else {
        startGameActual(); // Skip story and start game directly on restarts
    }
});
